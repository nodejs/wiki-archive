...
* "MVC.js":http://github.com/tuxychandru/mvc.js/tree/master -- A simple MVC framework for **REST**-ful web applications & services, with integrated dependency injection support.
