...
* "Lightnode":http://www.ngspinners.com/lightnode/ -- Easy to understand. Fast. Provides simple framework. (heirarchical servers, delegation, caching, virtual hosts).
...
* "connect-force-domain":https://github.com/shapeshed/connect-force-domain -- force all visitors onto a single domain  (Connect)
