...
* "compress":http://github.com/kriszyp/pintura/blob/master/lib/jsgi/compress.js - Gzip compresses the response when appropriate based on request headers. (JSGI)
...
* "rewriter":http://github.com/kriszyp/pintura/blob/master/lib/jsgi/rewriter.js - Redirects defined paths to other URLs. (JSGI)
...
* "http-params":http://github.com/kriszyp/pintura/blob/master/lib/jsgi/http-params.js - Converts HTTP parameters http-<name> to headers
* "auth":http://github.com/kriszyp/pintura/blob/master/lib/jsgi/auth.js - Handles Authentication (HTTP and cookie based)
