...
* "jqtpl":http://github.com/kof/node-jqtpl -- A port of the new jQuery template engine.
...
* "CoffeeKup":http://github.com/mauricemach/coffeekup -- Markup as CoffeeScript. (sep 2010, node 0.2.0)
...
* "Hash":http://github.com/michaelsbradleyjr/Hash -- md5 and sha256 methods implemented purely in JavaScript, same module can be used with node.js and in browsers, extensively tested against ASCII and UTF-8 input.
...
* "n3":http://github.com/andris9/n3 -- Experimental POP3 server to serve arbritary data to e-mail client software
...
* "Search":http://github.com/talltyler/Search -- A full text search
