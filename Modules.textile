...
* "akismet-js":https://github.com/oozcitak/akismet-js -- A wrapper for Akismet API
...
* "node-multivariate":http://github.com/grippy/node-multivariate — Application and framework for conducting A/B or Multivariate webpage testing (similar to mixpanel but with less features). Uses Redis as a datastore 
