...
* "MVC.js":http://github.com/tuxychandru/mvc.js/tree/master -- A simple MVC framework for **REST**-ful applications, with integrated **dependency injection**, **session management** and **smart templates**.
...
* "connect-rpx":http://github.com/xrd/connect-rpx - Use RPX with Node.js and Connect (JSGI)
