...
* "markdown.js":http://github.com/visionmedia/markdown.js -- C markdown parser bindings
...
* "node-streamlogger":http://github.com/andrewvc/node-streamlogger -- File Logging library with support for log rotation
