...
h3(#deployment-helpers). "Deployment Helpers":#deployment-helpers
* "nodejs-autorestart":http://github.com/shimondoodkin/nodejs-autorestart -- run while true, watch all .js & restart on cahnge, easy development and stable production.
