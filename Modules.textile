...
* "joose":http://github.com/joose/joose -- complete modern object system for JavaScript, based on concepts from many programming languages such as Ruby, Smalltalk, Perl
