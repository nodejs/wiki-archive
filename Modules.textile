...
* "Eclipse debugger plugin":http://code.google.com/p/chromedevtools/wiki/EclipseDebugger -- Full featured V8 debugger (use port 5858, start node with --debug option)
