...
* "node-ipcbuffer":https://github.com/dazhazit/node-ipcbuffer -- A modified Buffer object to pass large amounts of data between processes using POSIX or System V IPX shared memory and or do fast read and writes to files. (Windows soon).
