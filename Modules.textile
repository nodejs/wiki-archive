...
* "node-mongo-provider":https://github.com/guileen/node-mongo-provider -- A javascript provider class for MongoDB to simplify the coding, base on node-mongodb-native.
