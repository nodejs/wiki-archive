...
* "Pulsar":https://github.com/michaelsbradleyjr/Pulsar -- Event emitter abstraction class; reuse custom-emitter logic across JavaScript environs, transparently falling back to node's EventEmitter.
