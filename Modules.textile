...
* "open-uri":https://github.com/publicclass/open-uri -- Client library similar to Rubys Open-URI, reads based on URI scheme (depends on "addressable":https://github.com/publicclass/addressable for the URI magic).
...
* "simple-geoip":https://github.com/dvv/simple-geoip -- Simple maxmind GeoIP lookup, doesn't require libgeoip. 4-6 times faster than node-maxmind-native. See wiki for details