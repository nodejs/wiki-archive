...
h3(#database). "Deployment Helpers":#deployment-helpers
* "nodejs-autorestart":http://github.com/shimondoodkin/nodejs-autorestart -- watch all .js & restart on cahnge, easy development and stable production.
