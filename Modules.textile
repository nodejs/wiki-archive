...
* "connect":http://github.com/senchalabs/Connect -- Connect provides a robust Express-like routing middleware
...
* "nodejs-autorestart":http://github.com/shimondoodkin/nodejs-autorestart -- easy development and stable production, run it while true, watch all .js & restart on change.
