...
*** <a href="#middleware" rel="nofollow">Middleware</a><br><a name="middleware-jsgi" rel="nofollow"></a>
...
*** <a href="#parser_generators" rel="nofollow">Parser Generators</a>
...
** <a href="#async-flow" rel="nofollow">Flow control / Async goodies</a>
...
<a name="web-frameworks-routers"></a>
...
<a name="web-frameworks-static"></a>
...
* "Meryl":https://github.com/coffeemate/meryl -- Minimalist web framework! See "wiki":http://github.com/coffeemate/meryl/wiki
...
* "node-mongodb-provider":https://github.com/guileen/node-mongodb-provider -- A javascript provider class for MongoDB to simplify the coding, base on node-mongodb-native.
* "node-orm":https://github.com/dresende/node-orm -- Basic ORM for multiple drivers (still in development, only MySQL driver for now)
...
* "weld":https://github.com/hij1nx/weld -- unobtrusive. portable. ANTI-TEMPLATING.
...
* "run":https://github.com/DTrejo/run.js -- Rerun your js file whenever there's a change in the current directory: <code>npm install run</code>, <code>runjs yourcode.js</code>. Never alt-tab to your terminal again.
...
* "Klass":https://github.com/polvero/klass -- An expressive, cross platform JavaScript Class provider with a slick, classical interface to prototypal inheritance. Includes extends, implements, and the ability to call super classes/methods
...
* "formaline":https://github.com/rootslab/formaline - module for handling simple form posts and fast parsing of file uploads
