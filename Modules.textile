...
* "node-mysql":http://github.com/Sannis/node-mysql -- Beginning of MySQL synchronous(async in future) binding based on libmysqlclient
...
* "node-promise":http://github.com/krizyp/node-promise -- Robust promises for node.js, includes promise utilities and promise-based I/O library
