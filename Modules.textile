...
* "sequelize":http://github.com/sdepold/sequelize -- An easy-to-use MySQL object-relationship-mapper for node.js
...
h3(#payment). "Payment Gateways":#payment
* "paynode":http://github.com/jamescarr/paynode -- wrappers for various payment gateway APIs.
...
* "node-stringprep":http://github.com/astro/node-stringprep -- Binding to ICU StringPrep profiles
...
* "schema.js":http://github.com/akidee/schema.js -- Modular data schema validation and adaptation according to JSON Schema for JavaScript (CommonJS)