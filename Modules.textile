...
* "sync":https://github.com/0ctave/node-sync -- Makes simple to run any asynchronous function in synchronous way, using "node-fibers":https://github.com/laverdet/node-fibers
