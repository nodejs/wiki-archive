...
h2(#modules). "Modules":#modules
  ...
  ** "static serving":#web-frameworks-static
  ** "micro frameworks":#web-frameworks-micro
  ** "frameworks":#web-frameworks-full
  ** "middleware":#web-frameworks-middleware
  ...
  ** "Parser Generators":#parser_generators
  ** "Other Parsers":#parsers-other
  * "Debuging / Console Utilities":#debugging
  * "Compression":#compression
  * "Graphics":#graphics
  * "Payment Gateways":#payment-gateways
  * "API Clients":#api-clients
  * "Flow Control / Async Goodies":#async-flow
  * "I18n & L10n modules":#i18n
  * "Other":#other
  * "Common JS compatible modules":#commonjs-compat
...
* "m1node":http://github.com/mikebannister/m1node -- A thin layer of utils for working with node.js, connect, express, CouchDB and friends
