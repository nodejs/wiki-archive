...
* "pintura":http://github.com/kriszyp/pintura -- REST-based web framework/"middleware":http://github.com/kriszyp/pintura/tree/master/lib/jsgi/ stack built for Ajax-style "JSON-driven thin server applications":http://www.sitepen.com/blog/2010/01/22/introducing-pintura/.
...
* "perstore":http://github.com/kriszyp/perstore -- JavaScript object store interface for mapping persistent objects to pluggable storage with the "W3C DB API":http://www.w3.org/TR/IndexedDB/
...
* "commonjs-utils":http://github.com/kriszyp/commonjs-utils -- JSON Schema, AOP, XML-RPC, lazy arrays, and other utilities
...
* "Dojo Toolkit (Node-compatible fork)":http://github.com/novemberborn/dojo
