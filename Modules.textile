...
* "JSON Template":http://github.com/andychu/json-template -- Minimal but powerful template language with multiple implementations.  Tis is the CommonJS version, tested on Node
