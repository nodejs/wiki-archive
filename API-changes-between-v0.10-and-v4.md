...
- [`http.OutgoingMessage.prototype.setHeader()`](https://iojs.org/api/http.html#http_response_setheader_name_value) will now throw an error if the second argument is undefined.
