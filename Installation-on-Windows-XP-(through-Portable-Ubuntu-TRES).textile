...
and you can go back to Windows and point your browser to http://127.0.0.1:8000 and it should work, provided you have the server listening to *port 8000* (if you want to use another port you need to edit *portable_ubuntu.conf* as described in step *2*). "Here are a few Hello World examples with code":http://howtonode.org/hello-node to get you started quickly.
