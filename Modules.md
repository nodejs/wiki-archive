...
* [simpleS](https://micnic.github.com/simpleS/) — Simple Server (designed to be All-In-One) with routing, static files service, response compression and WebSocket implementation (version 13, RFC 6455)
