...
* [partial.js](http://www.partialjs.com) - Web application framework (MVC) for node.js (__no dependencies__, __inspired by ASP.MVC & RAZOR__)
...
* [Kiwi](https://github.com/coolony/kiwi) — Simple yet powerful template engine based on jQuery Templates syntax, totally asynchronous, and built from the ground up with performance and modularity in mind. 
...
[Express](http://expressjs.com) 3.x compliant.
