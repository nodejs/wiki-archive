...
* [Raptor Templates](http://raptorjs.org/raptor-templates/) — Extensible and optimized HTML templating language that is part of [RaptorJS](http://raptorjs.org). Works in the browser and on the server.
