## Search for modules with [search.npmjs.org](http://search.npmjs.org/), [toolbox.no.de](http://toolbox.no.de/), & [eirikb.github.com/nipster](http://eirikb.github.com/nipster/).
