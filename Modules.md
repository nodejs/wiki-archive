## Search for modules with [search.npmjs.org](http://search.npmjs.org/), [toolbox.no.de](http://toolbox.no.de/), [npmdocs](http://npmdoc.jit.su) and [nipster](http://eirikb.github.com/nipster/).
