...
* "coffeemate":https://github.com/coffeemate/coffeemate -- the coffee creamer! Push coffeescript into web development.
...
** "formaline":https://github.com/rootslab/formaline - full-featured module for handling form POSTs/PUTs and fast parsing of file uploads, ready for use with connect middleware
...
*** "mongoq":https://github.com/zzdhidden/mongoq -- Use mongoDB like this: db('testdb').collection('users').find(function(err, cursor){}).
...
*** "couchtato":https://github.com/cliffano/couchtato/ -- CouchDB document iterator
** "NoSQL Misc":#db-misc
...
** "nconf":https://github.com/nodejitsu/nconf -- A hybrid local / remote configuration storage library
...
* "weld":https://github.com/nodejitsu/weld -- Weld binds data to markup, and can generate markup based on your data.
...
* "websocket-node":https://github.com/Worlize/WebSocket-Node -- A WebSocket library that tracks the latest protocol draft versions released by the IETF HyBi working group, currently draft-07.  Experimental.  Mainstream browsers do not yet support this draft of the protocol.
...
* "Winston":https://github.com/nodejitsu/winston -- A multi-transport async logging library for node.js
...
* "$N":https://github.com/chjj/-N -- Simple flow control with pretty syntax.
...
* "neuron":https://github.com/nodejitsu/neuron -- The simplest possible event driven job manager, FIFO queue, and "task based cache" in node.js
...
* "QBox":https://github.com/arunoda/qbox -- Quick Flow Controller for NodeJS
...
* "node-init":https://github.com/frodwith/node-init -- Turn your node daemon into an LSB-compatible init script
...
* "node-simple-cdn":https://github.com/semu/node-simple-cdn -- Simple Content Delivery Network host ballancing for node
...
* "youtube-dl":https://github.com/Neat/node-youtube-dl -- A youtube-dl driver for node.
* "inflect":https://github.com/MSNexploder/inflect -- A port of the Rails / ActiveSupport inflector to JavaScript.
