...
* [Sails](http://sailsjs.org) — A realtime MVC framework, based on Express and Socket.io, featuring an ORM with support for Mongo, MySQL, Postgres, Redis, Riak, and others.
