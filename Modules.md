...
* [partial.js](http://www.partialjs.com) - Web application framework (MVC) for node.js (no dependencies, all in one, small, fast and safe) **inspired by ASP.MVC and Razor**
...
* [hapi](https://github.com/spumko/hapi) — A rich framework for building restful API services. **hapi** enables developers to focus on writing reusable business logic.
...
* [Sails](https://github.com/balderdashy/sails) — A realtime MVC framework, based on Express, Socket.io, and Sequelize.
...
* [Tower](https://github.com/viatropos/tower) — Full Stack Web Framework for Node.js and the Browser, **inspired by Ruby on Rails**.
...
* [partial-mongolab](https://github.com/petersirka/node-mongolab) - Simple node.js MongoDB REST client for MongoLab.com
...
* [partial-couchdb](https://github.com/petersirka/node-couchdb) - A simple client for CouchDB
...
* [nosql](https://github.com/petersirka/nosql) - node.js NoSQL embedded database written in JavaScript (insert, update, remove, read and supports views)
...
* [simple-js](https://github.com/flosse/simple-js) — A simple JSON store
...
* [simpleT](http://micnic.github.com/simpleT/) — Simple Template Engine with automatic caching, html character escaping, client-side support and **clean result**
...
* [node-opencv](https://github.com/talvarez/node-opencv) — Node.js bindings