...
* [COKE](https://github.com/dreamerslab/coke) -- A MVC framework base on [Express](http://expressjs.com/). It does not add too many magic, instead it provides a clean and well structured project bootstrap. (Rails like web framework)
