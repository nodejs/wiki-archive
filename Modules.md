...
* [mincer](https://github.com/nodeca/mincer) -- direct sprockets assets manager port, with  middleware for connect
...
* [node-oracle-plsql-page(psp.web)](https://github.com/kaven276/node-oracle-plsql-page) -- NodeJS gateway for oracle plsql server page and for javascript to call oracle stored plsql procedure.
...
* [node-sms](https://github.com/kaven276/sms) -- Aimed at whole SGIP/SMPP nodes support for SMS system, now focused on SP function.
