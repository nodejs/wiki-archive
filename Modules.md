...
* "Web.js":https://github.com/iwillwen/webjs -- A simple, fast and light HTTP/TCP framework for NodeJS
...
* "nitrix":https://github.com/edwardhotchkiss/nitrix -- A CLI and Daemon tool to run a NodeJS process forever, restarting on file changes and crashes with piping to stdout or log files
...
* "attache.js":https://github.com/rodzyn/attache.js - Very basic AOP implementationCheck out "search.npmjs.org":http://search.npmjs.org/ too
