...
* [node-mysql](https://github.com/felixge/node-mysql) -- A node.js module implementing the MySQL protocol
  ...
  * [node-mysql-queues](https://github.com/bminer/node-mysql-queues) -- Wraps 'node-mysql' to provide mulitple query queues, allowing support for multiple statements and transactions.
