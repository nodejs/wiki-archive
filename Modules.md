...
* [Mojito](https://github.com/yahoo/mojito/) — An MVC framework and JavaScript library for building high-performance, device-independent HTML5 applications running on both client (browser) and server (Node.js). See the [Mojito Documentation Directory](http://developer.yahoo.com/cocktails/mojito/docs/) for more information.
* [Monorail.js](https://github.com/runexec/Monorail.js) — Ultra leightweight MVC web framework.
