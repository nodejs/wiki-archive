...
* [nCombo](https://github.com/topcloudsystems/ncombo) — A client-server framework for building rich cloud applications
...
* [simpleS](https://github.com/micnic/simpleS/) — Simple Server (designed to be All-In-One) with routing, static files service, response compression and WebSocket implementation (version 13, RFC 6455)
