...
* "Common Node":https://github.com/olegp/common-node -- Synchronous CommonJS compatibility layer that includes JSGI, Binary, IO, Filesystem, System and HttpClient modules
...
* "weld":https://github.com/hij1nx/weld -- Weld binds data to markup, and can generate markup based on your data.
...
* -"node-radio-stream"-:https://github.com/TooTallNate/node-radio-stream -- An interface for connecting to, parsing metadata, and reading from SHOUTcast/Icecast radio streams- (broken link)
* -"ndns"-:https://github.com/skampler/ndns -- -DNS client/server library and parser- (broken link)
...
* "begin":https://github.com/arumons/begin -- Flow control library for node.js and CoffeeScript
...
* "nestor":https://github.com/cliffano/nestor -- Jenkins NodeJS CLI
