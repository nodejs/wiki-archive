...
* "Szpil":https://szpil.com - CRM using Node and TokyoCabinet. Shares model code and database code between client/server to simplify offline access, decouples the user interface from the network, performs API retrieval and authorization at the meta-data layer to avoid JSON deserialization/serialization overhead.
