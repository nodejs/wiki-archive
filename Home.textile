...
* "flickrnode":http://github.com/ciaranj/flickrnode -- An alternative library to enable easy use of the flickr api (less complete than node-flickr, but with support for authentication)
