...
* "Szpil":https://szpil.com - Collaborative contact management software powered by Node.js and TokyoCabinet. Shares model code and database code between client/server to support offline access, decouples the user interface from the network, and performs API retrieval and authorization at the meta-data layer to avoid JSON deserialization/serialization overhead.
...
* "Szpil":https://szpil.com - Keep detailed contact histories. Review past calls and conversations. Collaborate with your colleagues. 
