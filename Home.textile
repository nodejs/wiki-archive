...
The "installation guide":https://github.com/ry/node/wiki/Installation explains how to get started installing Node.js and the Node Package Manager (NPM) on your system.
...
Most modules are in the "npm registry":http://search.npmjs.org/ 
There is also a list of modules on this wiki: "Modules":http://github.com/ry/node/wiki/modules page.
...
Node releases a new version every one or two weeks. The official ChangeLog can always be found "here":https://github.com/ry/node/blob/master/ChangeLog  "forex signals":http://signalsforex.org/
...
see the "API Doc":http://nodejs.org/docs/latest/api/index.html