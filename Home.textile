...
* "The API Playground":http://github.com/jashkenas/api-playground - A website where journalists can play with API examples, written in CoffeeScript and Express. "apiplayground.org":http://apiplayground.org
