...
**Attention Node Users** Version 0.8 will be out soon.  If you are currently using 0.6, please read "API changes between v0.6 and v0.8":https://github.com/joyent/node/wiki/API-changes-between-v0.6-and-v0.8 and update your programs accordingly.
