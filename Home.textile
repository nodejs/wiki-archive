...
* "q-chess":http://github.com/wsdookadr/Q-Chess/tree/rewrite by wsookadr — chess game multiplayer server using [[faye|http://github.com/jcoglan/faye]] + client written using [[Qooxdoo|http://qooxdoo.org/]] 
