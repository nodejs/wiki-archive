...
* "Socket.IO":http://github.com/LearnBoost/Socket.IO-node - An abstraction over all the realtime transports (WebSocket, XHR long polling, XHR multipart, Server-Sent Events, etc) for the Node HTTP server.
