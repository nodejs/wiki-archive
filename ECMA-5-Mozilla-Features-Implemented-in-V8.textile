 ...
 * @defineProperty(obj, prop, desc)@ - Defines a property on an object with the given descriptor
 * @defineProperties(obj, props)@ - Adds own properties and/or updates the attributes of existing own properties of an object
