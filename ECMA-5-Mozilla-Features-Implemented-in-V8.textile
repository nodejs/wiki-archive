 ...
 * @Object.seal(obj)@ - Keeps an object from having its properties added to, deleted from, or changing the descriptors of any properties of the object. Property values can be changed however.
