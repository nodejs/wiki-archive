...
h2. Object
 * @Object.create( proto, props )@ - Creates a new object whose prototype is the passed in parent object. 
 * @Object.keys(object)@ - Returns a list of the ownProperties of an object that are enumerable.
 ...
 * @Object.getOwnPropertyNames(object)@ - Returns a list of the ownProperties of an object including ones that are not enumerable.
 * @Object.getPrototypeOf(object)@ - Returns the prototype of an object.
 * @Object.getOwnPropertyDescriptor(object, property)@ - Returns an object with keys describing the description of a property (value, writable, enumerable, configurable)
 ...
 * @Object.freeze( obj )@ - Keeps an object from having its properties added to, deleted from, or edited.
...
h2. JSON
 * @JSON.stringify(object)@ - Takes any serializable object and returns the JSON representation as a string.
