...
* "wikiedge.org": http://www.wikiedge.org/ - A website to promote Chinese Wikipedia by deliver a daily magazine by good Wikipedia content, it is an opensource project, and code is at https://github.com/mountain/distilled .
...
* "Kodingen":http://kodingen.com/ - Cloud IDE using nodejs backend to execute tasks.
