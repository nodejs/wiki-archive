...
* "4TIC":http://4tic.com -- Amazing & Rich web applications.
...
* "AllMobilize":http://www.allmobilize.com/ -- Make websites mobile! Uses Node.js for backend and page crawling. 
* "AppFog":http://www.appfog.com/ -- Leading polyglot/poly-infrastructure PaaS provider. Uses node.js for its back end.
...
* "BandPage":http://www.bandpage.com/ - Used by musicians to share music, videos, photos, touring schedule and more with their fans. 
* "Bitmechanic":http://www.bitmechanic.com/
* "Bocoup":http://bocoup.com
* "BrandedCode":http://brandedcode.com
* "Brightin":http://brightin.nl - Creating simple, often realtime, apps
...
* "CarterCole.com":http://blog.cartercole.com/2010/02/seo-site-tools-chrome-seo-extension.html - SEO Site Tools data is pulled with Node.js for SEO data monitoring 
...
* "Copenhagen Code":http://muscula.com -- uses Node.js and MongoDB for several projects
...
* "DIY":https://diy.org/ -- A community for young makers
...
* "Doodle or Die":http://doodleordie.com - online social doodling game (developed entirely in node)
...
* "Empeeric":http://www.empeeric.com - Alchemists of excellent software
...
* "Errorception":http://errorception.com - uses node to manage and manipulate data about JavaScript errors in browser clients
* "Firmwater LMS":http://www.firmwater.com - Node builds and deploys our Learning Management System (LMS).
...
* "Gigzolo":http://gigzolo.com - Helping consumers find and book live entertainment online.   
...
* "inweso":http://www.inweso.ch/ - A company that uses the latest technologies such as node.js, HTML5 and JavaScript to create web based systems for their customers.
* "ipowerhouse":http://www.ipowerhouse.com - Focused on haXe/Node.js  game dev; first all haxe/node bingo product.
* "ipseitycloud":http://www.ipseitycloud.com - Use node.js for everything, blog, apps, webpage, etc
...
* "Jetpacks for Dinosaurs":http://jetpacksfordinosaurs.com" - Node.js Consultancy and Startup incubator.
...
* "Keaton Row":http://keatonrow.com/ - Online personal shopping and styling service for the professional woman.
* "Kinvey":http://kinvey.com/ - A Backend as a Service platform that makes really easy for developers to setup and operate backends for mobile, tablet AND web apps.
...
* "LinkedIn":http://linkedin - Use node.js as the server interface for his mobile applications
...
* "Marlabs":http://marlabs.com/ -- Uses Node.js to build cloud apps on the Windows Azure.
...
* "Mixtaping.fm":http://www.mixtaping.fm - Create, discover and share mixtapes with your friends.
...
* "NH7":http://nh7.in -- uses node on a variety of projects
...
* "page-buddies":http://page-buddies.com/ - social chat for websites
...
* "Picturelife":http://picturelife.com -- private, secure backup of your photos.
...
* "Pokki":http://www.pokki.com/ -- using node for real-time platform analytics
* "PrivyTV":http://www.privytv.com - We are using Node for our digital signage and social products.
...
* "ScientiaMobile":http://www.scientiamobile.com - Cloud Mobile Device Detection through a "Device Description Repository (DDR) in the Cloud":http://www.scientiamobile.com/wurflCloud/gettingStarted/ .
...
* "Software Projects":http://www.softwareprojects.com - Real-time Job queue
...
* "Uber":https://uber.com - Everyone's Private Driver
...
* "Vercingetorix Technologies":http://vxtindia.com -- a mobile app development company which now builds all their APIs in node
...
* "WatchInSync":http://www.watchinsync.com/ -- A website for people to watch Youtube videos in synchronization in a "video chat room." It runs on node, Express and socket.io, while using YouTube api and tokbox api.
...
* "Sudoku Battle":http://apps.facebook.com/sudokuquest/?ref=nodewiki -- Multiplayer realtime sudoku with node + socket.io on facebook
...
* "BrowserQuest":http://browserquest.mozilla.org/ - Mozilla's experimental, browser-based MMORPG.
...
* "Countly":http://count.ly/ - Open source, real-time mobile analytics platform that runs on MongoDB and Node.js
...
* "Debitoor":http://debitoor.de — Online invoicing (German), uses Node.js and MongoDB
...
* "Fluid.js":https://github.com/peteclark82/node-fluid -- An extension to the existing Async module. Dynamically create fluent interfaces the easy way. Chain method calls across multiple objects and flow control types. Consume ANY object fluently.
...
* "Hall.com":https://hall.com - Realtime chat and collaboration for business.
* "Hummingbird":http://hummingbirdstats.com/ -- A realtime web analytics app using socket.io
* "Html2pdf.it":http://html2pdf.it/ -- Service for converting HTML to PDF using the API
* "instant message God":http://imgod.me - Social Art project using node and MySQL
* "instapolls":http://instapoll.in - Realtime polls using node.js, Socket.IO and mongodb
* "in1":http://www.in1.com - social media aggregation and sharing using node.js, Express and Mongo
...
* "lebdo":http://www.lebdo.ch - A curriculum-based monitoring documentation tool for the nursery level. A single-page evented web app built with socket.io and mongodb.
* "LifeInText":http://github.com/weilawei/LifeInText -- LiT is a mashup platform for personal projects and snippets.
* "LiveChant":http://www.livechant.com -- LiveChant is an online platform to connect offline businesses to their users simply, directly and locally.
...
* "Muscula":http://muscula.com - Log you JavaScript errors in production. "architecture":http://www.muscula.com/architecture
...
* "page-buddies":http://page-buddies.com/ -- A social chat widget for web sites
...
* "RESTMailer":http://restmailer.mihirgarimella.com - Easy contact forms, powered by HTTP REST. You make the form and RESTMailer does the rest. Powered by node.js, MongoDB, and PostageApp.
...
* "Socky":https://github.com/lannafred/socky — Forum software built with Socket.IO and node.
* "SoundType":https://github.com/jdherman/soundtype - Play MIDI music with other people in real time. Uses NowJS for WebSockets. ("http://soundtype.com":http://soundtype.com)
...
* "view-test":https://github.com/gtmtg/view-test - A command line app that enables easy testing of Jade and EJS templates. Powered by node.js and express.
...
* "Pade.me":http://pade.me - social events & meetups magazine
* "nirc":https://github.com/cjstewart88/nirc - A simple web browser irc client for connecting to any irc server.