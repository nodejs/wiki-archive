...
* "gevorg.me":http://gevorg.me - Gevorg Harutyunyan's work and basic information details.
...
* "Clock Limited":http://www.clock.co.uk - Top 100, Award-winning design and build agency specialising in node. 
...
Anyone else think that all the "Modules":https://github.com/joyent/node/wiki/modules listed here should be removed, and to remove ambiguity between modules and projects/applications, projects/applications should be renamed to websites/apps (not modules).
