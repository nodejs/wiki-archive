...
* "Fluid.js":https://github.com/peteclark82/node-fluid -- Dynamically create fluent interfaces the easy way. Chain method calls across multiple objects and flow control types, consume ANY object fluently.
