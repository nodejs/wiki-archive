...
* "Duostack":http://www.duostack.com/  - Acquired by Dotcloud - still accepting signup, but no new apps can be deployed
* "Heroku":http://heroku.com/ - Closed Beta
* "no.de":http://no.de - Acquired by Dotcloud - still accepting signup, but no new apps can be deployed
