...
Now you can start debugging session on local port 5858 as usual. Note that tcpproxy.js needs to be started only once for particular remote host and port combination.
