...
Now you can start debugging session on local port 5858 as usual. Note that tcpproxy.js needs to be started only once for particular remote host and port combination. If verbose option is set for the above script, it can be used as s sniffer for "V8 Debugger protocol":http://code.google.com/p/chromedevtools/wiki/ChromeDevToolsProtocol as well.
